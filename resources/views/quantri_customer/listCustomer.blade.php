                ...
                <tbody>
                    ...
                    @foreach ($dataCustomer as $customer)
                        <tr>
                            ...
                            <td>
                                @if ($customer->role == app\Models\Customer::CUSTOMER)
                                    <span class="badge badge-primary">
                                        {{ app\Models\Customer::convertRoleFromIntToString($customer->role)}}</span>
                                @elseif($customer->role == app\Models\Customer::BUSINESSMAN)
                            ...
                            <td>
                                @if ($customer->status == app\Models\Customer::UNACTIVE)
                                    <span class="badge badge-primary">
                                        {{ app\Models\Customer::convertStatusFromIntToString($customer->status)}}</span>
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('member.customer.detail', [$customer->id]) }}"
                                            ...
                                            @if ($customer->status == app\Models\Customer::UNACTIVE || $customer->status == app\Models\Customer::DISABLE)
                                                <a href="{{ route('member.customer.update_status', [$customer->id,$customer->status]) }}"
