...
class MailApprovalBusinessman extends AbtractMailBase{
    ...
    public function sendMail($user){
        ...
        $header = "Các thông tin cần thiết trong quá trình trở thành thương nhân của bạn đã hoàn tất";

        $this->setTitle("Duyệt thương nhân");
        ...
        $this->setContent("Bạn đã trở thành thương nhân");
